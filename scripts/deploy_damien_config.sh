...
# script must be run on the target EC2 instance (eg, damien-dev).
#
# -------------------------------------------------------------------
...
config_location="s3://damien-deploy-configs/damien/${eb_env}.py"
...
echo; echo "Done!"; echo
echo "Restart Damien to pick up new configs. Have a nice day!"; echo
